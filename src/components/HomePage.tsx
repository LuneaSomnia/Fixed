...
const HomePage: React.FC<HomePageProps> = ({ onNavigateToCatalog }) => {
  ...
  const handleWhatsAppOption = () => {
    const message =
      "Hello SeasideSeafood,%0A%0AI would like to inquire about your seafood products.%0A%0AThank you!";
  ...
  const handleEmailClick = () => {
    window.open(
      "https://mail.google.com/mail/?view=cm&fs=1&to=seafoodseaside7@gmail.com&su=Seafood%20Inquiry&body=Hello%20SeasideSeafood,%0A%0AI%20would%20like%20to%20inquire%20about%20your%20seafood%20products.%0A%0AThank%20you!",
      "_blank"
    );
  };
    ...
    <div className="relative">
      ...
      <div className="relative z-10">
        ...
        <section className="flex flex-col items-center justify-center min-h-screen px-4 sm:px-8 text-center text-white">
          ...
          <h1
            className="text-4xl sm:text-6xl font-bold mb-4 bg-gradient-to-r from-orange-400 via-orange-500 to-cyan-400 bg-clip-text text-transparent drop-shadow-2xl"
            style={{
              filter:
          ...
          <h2
            className="text-2xl sm:text-3xl font-semibold text-white mb-6 drop-shadow-lg"
            style={{
              filter:
                "drop-shadow(0 0 10px rgba(255,165,0,0.7)) drop-shadow(0 0 20px rgba(0,191,255,0.5))",
            }}
