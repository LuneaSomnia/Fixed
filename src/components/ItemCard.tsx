    ...
    <div className="bg-white/15 backdrop-blur-lg rounded-lg p-3 border border-white/25 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
      ...
      <div className="space-y-2">
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-blue-500/80 to-orange-500/80 backdrop-blur-sm text-white py-2 px-2 rounded-md font-medium shadow-lg hover:shadow-xl transition-all duration-300 flex items-center justify-center space-x-1 transform hover:scale-105 border border-white/20 text-xs"
        >
